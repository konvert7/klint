...
export function printHelp(): void {
  ...
  process.stdout.write(
    [
      ...
      "                   --symlink        install as symlink (npm package only, stays in sync)",
      "                   --copy           install as copy (default in non-TTY)",
      "",
      "  A copied skill records the version and hash it came from, and klint warns",
      "  with klint/skill-stale once the shipped skill moves on.",
      "",
